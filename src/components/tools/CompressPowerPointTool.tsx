  ...
  if (!doc) {
    return (
      <FileDrop
        ...
        sub="Best for shrinking images inside PPT files."
      />
    );
  }
  ...
  return (
    <div className="stack" style={{ gap: "var(--s-5)" }}>
      ...
      <Banner kind="info" title="How this works">
        Compression extracts images from the presentation and re-compresses them. It will shrink image-heavy slides but won&apos;t help pure text files.
      </Banner>

      <div className="run-bar">
        <RunButton onClick={handleProcess} disabled={processing} busy={processing} icon="compress">
          {processing ? "Compressing..." : "Compress Presentation"}
        </RunButton>
